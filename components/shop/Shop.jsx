      ...
      <Toaster position='top-right' richColors />
        ...
        <div className='min-h-screen bg-transparent py-12 px-4 sm:px-6 lg:px-8'>
          {session && (
            ...
            <div className='text-green-700 text-2xl md:text-3xl text-center mb-4'>
              Welcome back {session.user?.name} to our shop...
            </div>
          )}
          <h1 className='text-3xl font-bold text-green-700 text-center mb-3'>Shop Our Products</h1>
          {error && (
